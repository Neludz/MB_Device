...
#define MST_BUF_TABLE(a)\
    a##_X_MST_PAR(0, DEV_1  , "192.168.0.123", 5000  , 1     , CYCLIC_D  , 0 , mst_user_cb ) \
    a##_X_MST_PAR(1, DEV_2  , "192.168.0.123", 5000  , 1     , CYCLIC_D  , 0 , mst_user_cb ) \
    a##_X_MST_PAR(2, DEV_3  , "192.168.0.123", 5000  , 1     , CYCLIC_D  , 0 , mst_user_cb) \
    a##_X_MST_PAR(3, DEV_4  , "192.168.0.123", 5000  , 1     , CYCLIC_D   , 0 , mst_user_cb) \
    a##_X_MST_PAR(4, DEV_5  , "192.168.0.123", 5000  , 1     , CYCLIC_D   , 0 , mst_user_cb)
